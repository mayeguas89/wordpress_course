<?php 
  // Si el user no esta logeado lo sacamos a la web principal y exit para no ser capaces de acceder a recursos
          ...
          <ul class="min-list link-list" id="my-notes">
            ...
            ?>
              <li data-id="<?php the_ID() ?>">
                ...
                <span class="delete-note"><i class="fa fa-trahs-o" aria-hidden="true"></i>Delete</span>
